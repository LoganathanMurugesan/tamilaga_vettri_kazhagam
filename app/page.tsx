...
export default function HomePage() {
  ...
  return (
    <div className="bg-white">
      ...
      {/* ══════════════════════════════════════════════
          HERO — cream bg, tight 3-column layout
      ══════════════════════════════════════════════ */}
      <section
      ...
      >
        ...
        {/* Warm glow behind image — centred */}
        <div
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-10">
          <div className="grid grid-cols-12 items-stretch" style={{ minHeight: "54vh" }}>
            ...
            <div className="col-span-12 lg:col-span-4 flex flex-col justify-center py-10 lg:py-0 lg:pr-6 z-10">

              {/* Live-status pill */}
              <div
                className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-bold mb-5 w-fit"
              ...
              <h1 className="font-black leading-[1.05] tracking-tight mb-1">
                <span
                  className="block"
                  style={{ fontSize: "clamp(2.6rem, 3.8vw, 3.6rem)", color: "#1a1a1a" }}
                >
                  Ungal Kural.
                </span>
                <span
                  className="block"
                  style={{ fontSize: "clamp(2.6rem, 3.8vw, 3.6rem)", color: "#8f0d0d" }}
                >
                  Engal Poruppu.
                </span>
              </h1>
              ...
              <p className="text-sm leading-relaxed mb-6" style={{ color: "#6b6b6b", maxWidth: 320 }}>
                ...
                Sollinganallur ECR — complaint by complaint.
              </p>
              ...
              <div className="grid grid-cols-2 gap-2.5">
                {[
                  ...
                  <Link
                    key={href}
                    href={href}
                    className="flex items-center gap-2.5 px-3.5 py-3 rounded-2xl font-bold hover:opacity-90 hover:scale-[1.02] transition-all shadow-sm"
            ...
            {/* ── Col C: Leader identity card (3 cols) ── */}
            <div className="col-span-12 lg:col-span-3 flex flex-col justify-center py-6 lg:py-0 lg:pl-4 z-10">
              <div
                className="rounded-2xl overflow-hidden"
                style={{
                  border: "1.5px solid #e8d9d0",
                  boxShadow: "0 8px 28px rgba(143,13,13,0.10)",
                }}
              >
                {/* Maroon name banner */}
                <div
                ...
                >
                  ...
                  <div className="text-xs mt-0.5 text-white/70 font-medium">
                    MLA – Shollinganallur ECR
                  </div>
                  {/* Gold underline */}
                ...
                >
                  ...
                  <span className="text-xs font-bold" style={{ color: "#8f0d0d" }}>
      ...
      {/* ══════════════════════════════════════════════
          METRICS STRIP — full-width maroon banner
      ══════════════════════════════════════════════ */}
          ...
          <div className="grid grid-cols-5">
            {metricCards.map(({ label, value, Icon }, i) => (
              <div
                ...
                style={{ borderRight: i < 4 ? "1px solid rgba(255,255,255,0.12)" : "none" }}
              >
                <div
                ...
                <div>
                  <div className="font-black text-xl leading-none text-white">{value}</div>
      ...
      {/* ══════════════════════════════════════════════
          MAIN CONTENT — complaint form + issues + track
      ══════════════════════════════════════════════ */}
      <section className="py-7" style={{ background: "#faf7f5" }}>
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
              ...
              <div className="bg-white rounded-2xl overflow-hidden" style={{ border: "1px solid #e8ddd8" }}>
                ...
                >
                  <div>
                    ...
                    <span className="text-xs ml-2" style={{ color: "#aaa" }}>Tap to raise a complaint instantly</span>
                  </div>
                  <Link
                    href="/complaints/new"
                ...
                <div className="grid grid-cols-8 gap-0 p-3">
                  {issueIcons.map(({ key, Icon, color, bg }) => (
                    <Link
                      key={key}
                      href={`/complaints/new?category=${key}`}
                      className="flex flex-col items-center gap-1.5 py-3 px-1 rounded-xl hover:scale-105 transition-all mx-0.5"
                      style={{ background: bg }}
                    >
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-white rounded-2xl p-4" style={{ border: "1px solid #e8ddd8" }}>
                  ...
                  <div
                    ...
                    style={{
                      height: 118,
                      background: "linear-gradient(145deg, #c3d9ed 0%, #b4c8d9 40%, #c0d4ba 100%)",
                    }}
                  >
                    {[
                    ...
                    {/* Legend */}
                    <div
                      className="absolute bottom-2 right-2 bg-white/90 rounded-lg px-2 py-1.5 backdrop-blur-sm"
      ...
      <section className="py-6 bg-white" style={{ borderTop: "1px solid #f0e8e3" }}>
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="font-black text-sm tracking-wide" style={{ color: "#8f0d0d" }}>
              QUICK SERVICES
            </h2>
          </div>
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-3">
            {shortcuts.map(({ label, Icon, color, bg, href }) => (
              <Link
                key={href}
                href={href}
                className="flex flex-col items-center gap-2 py-4 px-2 rounded-2xl hover:scale-[1.04] hover:shadow-md transition-all text-center"
                style={{ background: bg }}
              >
                <div
      ...
      {/* ══════════════════════════════════════════════
          RECENT UPDATES — 4-col card grid
      ══════════════════════════════════════════════ */}
      <section className="py-8" style={{ background: "#faf7f5", borderTop: "1px solid #f0e8e3" }}>
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="flex items-center justify-between mb-5">
            <div className="flex items-center gap-2">
              <div className="w-1 h-6 rounded-full" style={{ background: "#8f0d0d" }} />
              <div>
                <h2 className="font-black text-lg leading-tight" style={{ color: "#8f0d0d" }}>
                  {t("recentUpdates")}
                </h2>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {UPDATES.map((update) => (
              ...
              >
                ...
                <div className="p-3">
                  <h3 className="font-bold text-xs mb-1.5 leading-tight line-clamp-2" style={{ color: "#1a1a1a" }}>
                    {update.title}
                  </h3>
